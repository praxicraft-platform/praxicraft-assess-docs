...
Event catalog and **sample payloads**: [Webhook events](/guides/webhook-events). Setup: [Webhooks](/guides/webhooks).
...
[Webhooks guide](/guides/webhooks) · [n8n trigger](/integrations/n8n) (verifies signatures for you)
