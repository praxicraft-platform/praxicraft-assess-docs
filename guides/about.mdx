...
- **Task**: One question on an assessment (`platform` library or your `org` library).
...
- **AI-ready docs**: [Build with agents](/integrations/build-with-agents), [Using docs with LLMs](/guides/using-llms), and [MCP](/integrations/assess-mcp)
