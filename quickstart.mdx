...
Want Greenhouse, Slack, or spreadsheets to update themselves? Ask an engineer to follow Path B, or use [n8n](/n8n) / [Automations](/automations).
...
- An owner, admin, or [developer](/roles) role (recruiters cannot mint keys)
- An **active** assessment (dashboard or [Assessments](/assessments) API)
...
<Steps>
  <Step title="Create an API key">
    ...
    Prefer least-privilege [scopes](/scopes). Empty scopes grant full access (legacy).
  </Step>
...
```
    ...
    In production, prefer [webhooks](/webhooks) (`assessment.completed`) instead of polling.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Automations" icon="workflow" href="/automations">
